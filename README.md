...
### Example htmlcore.config.json

Set up your htmlcore.config.json file in ./htmlcore
...
See [CONTRIBUTING.md](../../Contributing.md) on the main htmlcore repo for information about how to contribute.
